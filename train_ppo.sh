...
export HF_HOME='../cloud/cloud-s3fs'  # Set Hugging Face cache to ../cloud/cloud-s3fs for cloud storage
export DATA_DIR='../cloud/cloud-s3fs/data/nq_search'  # Updated to match new data dir
export HF_TOKEN=''  # Add your HF token for gated models

WAND_PROJECT='Search-R1'

export BASE_MODEL='Qwen/Qwen2.5-0.5B'
export EXPERIMENT_NAME=nq-search-r1-ppo-qwen2.5-0.5b-em
